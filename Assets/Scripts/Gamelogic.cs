...
public class Gamelogic : MonoBehaviour {
    ...
    //used to check logic for each item in a switch case
    private int playersObjectState = -1;
    private int cpuRandom = -1;
    ...
    private void PaperLogicCheck() {
        ...
        if (playersObjectState == 0 && cpuRandom != 2 && cpuRandom != 0) {
            ...
            //we probably could have done something here.
    ...
    private void ScissorsLogicCheck() {
        ...
        if (playersObjectState == 2 && cpuRandom != 2 && cpuRandom == 0) {
            ...
            //Debug.Log("cpu wins");
            cpuScore = cpuScore + 1;
            cpuScoreText.text = "Score: " + cpuScore.ToString();
